...
if(isset($_POST['ASC']))
{
$asc_query = "SELECT * FROM info ORDER BY full_name ASC where status = 'passive'";
$result = executeQuery($asc_query);
}
// Default Order
else {
$default_query = "SELECT * FROM info where status = 'passive'";
...
$tbl_name1="info";
    ...
    header("location:./index_employee_details1.php");    
...
<!--						<div class="row row-md m-b-2">
                        ...
                        <div class="box box-block bg-white">
							<div class ="row row-md m-b-2">
                                ...
                                <button class="btn btn-outline-primary btn-rounded w-min-sm m-b-0-25 waves-effect waves-light" data-toggle="modal" onclick="location.href='index_employee_details.php';">View Active</button>
								...
								<div class="modal-dialog" align="left">
									<div class="modal-content">
										...
										<div class="modal-body" data-role='content'>
											<form data-role="page" action=" " method="POST">
												...
												<div class="form-group">
													...
													<input type="text" name = "middlename"class="form-control" id="recipientname" required>
												</div>
												<div class="form-group">
										...
										<div class="modal-footer">
											<button type="button" class="btn btn-outline-success w-min-sm m-b-0-25 waves-effect waves-light" data-dismiss="modal">Close</button>
											<input type="submit" class="btn btn-outline-success w-min-sm m-b-0-25 waves-effect waves-light" value="Submit" name ="register">
