...
<html lang="en">
	<head>
        ...
        <script>
	       ...
	       var columns = new Array("full_name","department","email","address","salary");
            var placeholder = new Array("Enter Full Name","Enter Department","Enter Email","Enter Address","Enter Salary");
            var inputType = new Array("text","text","text","textarea","text");
            var table = "tableDemo";
				...
				<div class="custom-scroll custom-scroll-dark">
					<ul class="sidebar-menu">
                        ...
                        <li>
                         ...
                         <li class="with-sub">
							<a href="salary.html" class="waves-effect  waves-light">
							<!--
								<span class="s-caret"><i class="fa fa-angle-down"></i></span>
								<span class="tag tag-purple">12</span>
                            -->
