...
<html lang="en">
	...
	<body class="large-sidebar fixed-sidebar fixed-header">
				...
				<div class="content-area p-y-1">
					<div class="container-fluid">
						...
						<div class="box box-block bg-white">
							...
							<h5 class="m-b-1">Editable Table</h5>
							<p class="font-90 text-muted m-b-1">Click on cell which you want to change and enter.</p>
							<table class="table table-striped table-bordered editable-table" id="table-1">
								<thead>
									<tr>
		...
		<script type="text/javascript" src="../vendor/editable-table/mindmup-editabletable.js"></script>
		<script type="text/javascript" src="../vendor/editable-table/numeric-input-example.js"></script>

		<!-- Neptune JS -->
		<script type="text/javascript" src="js/app.js"></script>
		<script type="text/javascript" src="js/demo.js"></script>
		<script type="text/javascript" src="js/tables-editable.js"></script>
	</body>
</html>