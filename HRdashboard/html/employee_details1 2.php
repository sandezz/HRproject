...
$db = mysqli_select_db($connection,"testdatabase"); // Selecting Database
...
{
include("connection.php");
$connect = mysqli_connect("$host", "$username", "$password", "testdatabase");
				...
				<div class="content-area p-y-1">
					<div class="container-fluid">
                        <ol class="breadcrumb no-bg m-b-1">
								<li class="breadcrumb-item "><a href="employee_details1.php?id=<?php echo $_SESSION['id'];?>">Dashboard</a></li>
								...
								<div class="box bg-white user-5">
									<div class="u-content">
										<div class="avatar box-96 m-b-2">
											...
											<?php echo "<img src = 'user_images/$a' width='250px' height='180px' style='position:absolute;top:-15px;left:-50px; width : 200px;'>";}
                                        ...
                                        <li class="nav-item ">
										 ...
										 <li class="nav-item ">
											<a class="nav-link" href="#upload" role="tab" data-toggle="tab">
												<i class="pe-7s-users"></i> Upload your Documents
											</a>
										</li>
										 <li class="nav-item ">
											...
											<div class="box box-block bg-white">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
														...
														<input type="submit" class="btn btn-outline-primary btn-block waves-effect waves-light" name = "save" value = "Save"/>
                                                    </div>    
                                                </div>
                                            </form>
											</div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name = "phone" value="<?php echo $row1['phone']; ?>" class="form-control" data-mask="(999) 999-9999">
                                                        </div>
                                                        <div class="form-group">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" value="<?php echo $row1['mobile']; ?>" class="form-control" name="mobile" data-mask="0-1-9999999">
                                                        </div>
                                                        <div class="form-group">
											...
											<div class="box box-block bg-white">
                                                ...
                                                <div class="row">
                                                   <div class="col-md-12">
                                                       ...
                                                       <div class="input-daterange input-group" id="date-range">
                                                                <input type="text" class="form-control mydatepicker" name="fromdate" value="<?php echo $row1['fromdate']; ?>" placeholder="mm/dd/yy">
                                                                <span class="input-group-addon bg-primary b-0 text-white">to</span>
                                                                <input type="text" class="form-control mydatepicker" name="todate" value="<?php echo $row1['todate']; ?>" placeholder="mm/dd/yy">
                                                        </div>
                                                       <br/>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
														...
														<input type="submit" class="btn btn-block waves-effect waves-light btn-outline-primary" name = "save2" value = "Save"/>
                                                    </div>    
                                                </div>
                                                </form>
                                            </div>
											...
											<div class="box box-block bg-white">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
														...
														<input type="submit" class="btn btn-outline-primary btn-block waves-effect waves-light" name = "save4" value = "Save"/>
                                                    </div>    
                                                </div>
                                                </form>
                                            </div>
												...
												<table class="table table-striped table-bordered dataTable" id="table-2">
													<thead>
														...
														<tbody>
															...
															$db = mysqli_select_db($connection,"testdatabase"); // Selecting Database
															//MySQL Query to read data
															$query1 = mysqli_query($connection,"select * from upload_data");
											...
											<div class="box box-block bg-white">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
														...
														<input type="submit" class="btn btn-outline-primary btn-block waves-effect waves-light" name = "save6" value = "Save"/>
                                                    </div>    
                                                </div>
                                                </form>
                                            </div>
